...
const _URL_BASE = "http://localhost:8080";
                ...
                if(!this.v){
                    ...
                    $.ajax(settings).done(function (response) {  
                        if(response.code==1){
                            ...
                            v4Chat.v2 = blo0.blDiv(v4Chat,v4Chat.id+"v2","v2",blGrey[4]);
    ...
    b.onclick = function(){ 
        if(!b.v){
            ...
            tb.b1.onclick = function(){
                var settings = {
                    "url": _URL_BASE + "/api/getAllPlayers",
                    "method": "GET",
                    "timeout": 0,
                    "headers": {
            ...
            tb.b2.onclick = function(){
                ...
                var settings = {
                    "url": _URL_BASE + "/api/getPendingFriends",
                    "method": "GET",
                    "timeout": 0,
                    "headers": {
                        "Authorization": " Bearer " + _btn.token
                    ...
                    for(i in o){
                        ...
                        if(o[i].toID==_btn.userID && o[i].status=="Unkown"){
                            ...
                            b3.onclick = b4.onclick = function(_oi){
                                return function(){
                                    var settings = {
                                        "url": _URL_BASE + "/api/ReponseToMakeFriend",
                                        "method": "POST",
                                        "timeout": 0,
                                        "headers": {
                                            "accept": "application/json",
